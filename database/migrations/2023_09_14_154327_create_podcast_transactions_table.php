...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('podcast_transactions', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('data_id')->references('id')->on('podcasts')->onDelete('no action');
    ...
    {
        Schema::dropIfExists('podcast_transactions');
    }
};
