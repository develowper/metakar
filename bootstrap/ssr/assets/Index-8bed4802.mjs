    ...
    content: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_Link, {
          ...
          class: [$data.cardShadow, "flex hover:scale-[101%] transition duration-300 cursor-pointer shadow-sm items-center justify-around p-4 bg-white rounded-lg dark:bg-darker"]
        }, {
        ...
        return [
          ...
          createVNode("div", { class: "mt-2" }, [
            createVNode("div", { class: "grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-3" }, [
              createVNode("div", {
                class: [$data.cardShadow, "flex items-center justify-between p-4 bg-white rounded-lg dark:bg-darker"]
              }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Panel/Index.vue");
