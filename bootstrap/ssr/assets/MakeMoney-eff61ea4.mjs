...
const MakeMoney_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {
  data() {
    return {
      heroImage
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/MakeMoney.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const MakeMoney = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  MakeMoney as default
};
