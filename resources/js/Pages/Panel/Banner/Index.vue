            ...
            <tr v-for="(d,idx) in data"
              ...
              <td class="px-2 py-4    " data-te-dropdown-ref>
                <button
                    ...
                    :class="`bg-${getStatus('banner', d.status).color}-100 hover:bg-${getStatus('banner', d.status).color}-200 text-${getStatus('banner', d.status).color}-500`">
                  {{ getStatus('banner', d.status).name }}
                </button>
