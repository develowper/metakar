            ...
            <tr v-for="(d,idx) in data"
              ...
              <td class="px-2 py-4    " data-te-dropdown-ref>
                <button
                    ...
                    :class="`bg-${getStatus('video', d.status).color}-100 hover:bg-${getStatus('video', d.status).color}-200 text-${getStatus('video', d.status).color}-500`">
                  {{ getStatus('video', d.status).name }}
                </button>
