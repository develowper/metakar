              ...
              <div class="flex items-center justify-between">
                ...
                <div v-if="isAdmin()" class="flex items-center">
                  <label dir="ltr" v-if="data.article_id" class="mx-1 relative inline-flex items-center cursor-pointer">
                    ...
                    <span class="mx-1 text-sm select-none font-medium text-gray-900 dark:text-gray-300">  {{
                        __('rewrite_article')
                      }}</span>
                  </label>
              ...
              <div v-if="isAdmin()" class="   flex flex-col">
                ...
                <div v-for="(item,idx) in   data.items "
                  ...
                  <span v-if="item.item_id==null"
                        ...
                        class="rounded flex w-fit   my-1   cursor-pointer hover:bg-danger-400 bg-danger-500 items-center whitespace-nowrap rounded-e border     px-3 py-[0.25rem] text-center text-base font-normal leading-[1.6] text-neutral-700 dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200"
                  >
               <MinusIcon class="h-5 w-5 text-white font-bold"/>
                ...
                <span @click="data.items.push( {
                      ...
                      class="rounded flex w-fit self-end       cursor-pointer hover:bg-green-400 bg-green-500 items-center whitespace-nowrap rounded-e border     px-3 py-[0.25rem] text-center text-base font-normal leading-[1.6] text-neutral-700 dark:border-neutral-600 dark:text-neutral-200 dark:placeholder:text-neutral-200"
                >
