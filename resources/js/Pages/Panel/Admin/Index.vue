      ...
      <div class="mt-2">
        ...
        <div class="grid   gap-4 p-4 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3  ">
          ...
          <Link :href="route('panel.admin.setting.index')" :class="cardShadow"
                class="flex   hover:scale-[101%] transition duration-300 cursor-pointer   items-center justify-between p-4 bg-white  rounded-lg dark:bg-darker ">
            <div>
              <h6 class="text-xl font-bold   py-2 tracking-wider text-gray-500 uppercase dark:text-primary-light">
                {{ __('settings') }}
              </h6>
            ...
            <div>
              <Cog6ToothIcon class="w-12 h-12 text-primary-300 dark:text-pink-50 "/>
            </div>
          ...
          <div :class="cardShadow"
            ...
            <div class="  grow h-full flex items-stretch  ">
              ...
              <Link :href="route(`panel.admin.review.index`)"
                ...
                <span
                    class="  bg-pink-100 text-pink-500 mx-1 px-2 py-1    text-xs  rounded-md">
                                   {{ __('review_queue') }}
                                        </span>
              </Link>
            </div>
