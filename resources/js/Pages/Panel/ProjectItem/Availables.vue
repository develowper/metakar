    ...
    <template v-slot:content>
      ...
      <div class="px-2 flex flex-col   md:px-4">
        ...
        <div class="flex-col      overflow-x-auto    ">
          <div
              class="flex flex-wrap my-2 bg-white shadow-lg rounded-lg items-center justify-between   dark:bg-gray-800 p-4">
          ...
          <div class="grid grid-cols-1 xl:grid-cols-2  gap-2">
            <div v-for="(d,idx) in data"
                 class="bg-white shadow-lg text-center rounded-lg dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">

              <div
                  class="flex flex-col  justify-between h-full px-4 md:px-6 py-4 text-gray-500   dark:text-white">
