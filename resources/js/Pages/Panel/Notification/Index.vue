    ...
    <template v-slot:content>
      ...
      <div class="px-2 flex flex-col   md:px-4">
        ...
        <div class="flex-col   bg-white  overflow-x-auto shadow-lg  rounded-lg">
          ...
          <!--           table-->
          <div class="w-full   text-start text-gray-500 dark:text-gray-400">
            ...
            <div v-for="(d,idx) in data"
                 class="bg-white flex flex-col px-2 sm:px-8 py-2 text-start border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
