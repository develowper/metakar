  ...
  <div v-if=" song  "
    ...
    <div
      ...
      <div class="w-full flex flex-col px-6 sm:px-4 pb-6  " dir="ltr">
        ...
        <div :id="`progress-container-${forId}`" class="progress-container relative   h-[20px] cursor-pointer ">
          <div class="amplitude-wave-form"></div>
          <div class="amplitude-visualization"></div>
          <input type="range"
                 class=" amplitude-song-slider " :style="`background-size:${percentage}% 100%`"
                 step=".1" @change="changeTime "/>
          <progress :id="`song-played-progress-${forId}`" class="amplitude-song-played-progress "
                    value="0">

          </progress>
          <progress :id="`song-buffered-progress-${forId}`"
